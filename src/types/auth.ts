...
export const ROLE_METADATA: Record<string, RoleMetadata> = {
  ...
  admin_ministry_review: {
    ...
    persona: 'Administrative Ministry Reviewer',
  ...
  project_engineering: {
    ...
    persona: 'Project Engineering Officer',
  ...
  project_finance: {
    ...
    persona: 'Project Finance Officer',
  ...
  contractor_rep: {
    ...
    persona: 'Contractor Representative',
  ...
  supervision_consultant: {
    ...
    persona: 'Supervision Consultant',
  ...
  inter_ministerial_coordination: {
    ...
    persona: 'Inter-Ministerial Coordinator',
  ...
  state_coordination: {
    ...
    persona: 'State Coordination Officer',
  ...
  investment_appraisal_reviewer: {
    ...
    persona: 'Investment Appraisal Reviewer',
  ...
  financial_review_authority: {
    ...
    persona: 'Financial Review Authority',
