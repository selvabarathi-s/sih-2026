...
def run_tests():
    ...
    try:
        ...
        for username, password, expected_role in roles_to_test:
            ...
            assert user_role == expected_role or (expected_role == "system_admin" and user_role == "data_platform_security_admin"), f"Role mismatch for {username}: got {user_role}, expected {expected_role}"
